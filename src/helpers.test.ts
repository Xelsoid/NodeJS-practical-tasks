...
describe('Helpers tests',() => {
  describe("validateInput helper tests", () => {
    ...
    ])("should validate user input year: $year and country: $country", ({year, country, expected}) => {
    ...
    it.each([
      ...
      {year: 20233},
      {year: -102},
    ])("should throw error in case not valid year: $year passed", ({year}) => {
    ...
    it.each([
      ...
      {country: 'GR'},
      {country: 'SR'},
    ])("should throw error in case not valid country: $country passed", ({country}) => {
